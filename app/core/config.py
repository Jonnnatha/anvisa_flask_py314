...
MATERIALS_REQUEST_TIMEOUT = int(os.getenv('MATERIALS_REQUEST_TIMEOUT', '8'))
MATERIALS_TOTAL_TIMEOUT = int(os.getenv('MATERIALS_TOTAL_TIMEOUT', '15'))
MATERIALS_MAX_STRATEGIES = int(os.getenv('MATERIALS_MAX_STRATEGIES', '10'))
MATERIALS_MAX_TOTAL_ROWS = int(os.getenv('MATERIALS_MAX_TOTAL_ROWS', '120'))
MATERIALS_MAX_ROWS_PER_STRATEGY = int(os.getenv('MATERIALS_MAX_ROWS_PER_STRATEGY', '24'))
MATERIALS_MAX_SOURCES = int(os.getenv('MATERIALS_MAX_SOURCES', '20'))
MATERIALS_EARLY_STOP_RESULTS = int(os.getenv('MATERIALS_EARLY_STOP_RESULTS', '6'))
