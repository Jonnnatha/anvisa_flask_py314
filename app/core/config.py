...
PRODUCT_REQUEST_TIMEOUT = int(os.getenv('PRODUCT_REQUEST_TIMEOUT', '12'))
ALERTS_REQUEST_TIMEOUT = int(os.getenv('ALERTS_REQUEST_TIMEOUT', '10'))
MATERIALS_REQUEST_TIMEOUT = float(os.getenv('MATERIALS_REQUEST_TIMEOUT', '3.5'))
MATERIALS_TOTAL_TIMEOUT = float(os.getenv('MATERIALS_TOTAL_TIMEOUT', '8'))
MATERIALS_MAX_STRATEGIES = int(os.getenv('MATERIALS_MAX_STRATEGIES', '5'))
MATERIALS_MAX_TOTAL_ROWS = int(os.getenv('MATERIALS_MAX_TOTAL_ROWS', '12'))
MATERIALS_MAX_ROWS_PER_STRATEGY = int(os.getenv('MATERIALS_MAX_ROWS_PER_STRATEGY', '6'))
MATERIALS_MAX_SOURCES = int(os.getenv('MATERIALS_MAX_SOURCES', '10'))
MATERIALS_EARLY_STOP_RESULTS = int(os.getenv('MATERIALS_EARLY_STOP_RESULTS', '3'))
